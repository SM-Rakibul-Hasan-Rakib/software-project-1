    ...
    <div className="max-w-7xl mx-auto py-20">
      ...
      <PortfolioSideNav services={services}/>
        <div className="details flex flex-col gap-10 md:col-span-9">
          {/* card */}
          <div className="card relative border-2  p-6 rounded-lg">
          ...
          <div className="flex flex-col md:flex-row gap-10 items-start">
            ...
            <div className="flex justify-center md:justify-start">
              <img src={img} className="max-w-96 rounded-sm" alt="" />
            </div>
            {/* text description */}
            <div className="flex-1">
              <h3 className="text-2xl font-bold mb-7">
                Online Health help service app and Website - Telemedicine
                service system.
              </h3>
              <p>
